...
class Ball:
    ...
    def __init__(
        ...
        radius = mass / 2
        self.body.moment = pm.moment_for_circle(
            mass, inner_radius=0, outer_radius=radius
        )
...
class DoublePendulum:
    def __init__(
        ...
        *,
        ...
        ball1_pos = (
            piv_pos[0] - length1 * sin(theta1),
            piv_pos[1] - length1 * cos(theta1),
        )
        ball2_pos = (
            ball1_pos[0] - length2 * sin(theta2),
            ball1_pos[1] - length2 * cos(theta2),
        )
...
if __name__ == '__main__':
	sim = Simulation()
	DoublePendulum(sim.space, piv_pos=(1*WIDTH//2, 50), length1=400, theta1=-70, length2=160, theta2=50, ball_color=BALL_COLOR)
